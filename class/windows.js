...
SiteFusion.Classes.PromptService = function() {
	...
	SiteFusion.Classes.PrefPane.prototype.getTargetWindow = function() {
		//apply the check for the window being hidden.
	...
	SiteFusion.Classes.PrefPane.prototype.alert = function( title, text ) {
		this.promptService.alert( this.getTargetWindow(), title+'', text+'' );
	};
	
	SiteFusion.Classes.PrefPane.prototype.alertCheck = function( title, text, checkMsg, checkState ) {
	...
	SiteFusion.Classes.PrefPane.prototype.confirm = function( title, text ) {
		var result = this.promptService.confirm( this.getTargetWindow(), title+'', text+'' );
		this.fireEvent( 'yield', [ result, null, null, null, null ] );
	};
	
	SiteFusion.Classes.PrefPane.prototype.confirmCheck = function( title, text, checkMsg, checkState ) {
		checkState = { value: checkState };
	...
	SiteFusion.Classes.PrefPane.prototype.confirmEx = function( title, text, buttonFlags, button0Title, button1Title, button2Title, checkMsg, checkState ) {
		checkState = { value: checkState };
	...
	SiteFusion.Classes.PrefPane.prototype.prompt = function( title, text, textValue, checkMsg, checkState ) {
	...
	SiteFusion.Classes.PrefPane.prototype.promptUsernameAndPassword = function( title, text, username, password, checkMsg, checkState ) {
		if( checkMsg !== null ) checkMsg = checkMsg+'';
		checkState = { value: checkState };
	...
	SiteFusion.Classes.PrefPane.prototype.promptPassword = function( title, text, password, checkMsg, checkState ) {
		if( checkMsg !== null ) checkMsg = checkMsg+'';
		checkState = { value: checkState };
		password = { value: password+'' };
	...
	SiteFusion.Classes.PrefPane.prototype.select = function( title, text, list, index ) {
		index = { value: index };
