...
SiteFusion.Classes.CodeEditor.prototype = Object.create(SiteFusion.Classes.Editor.prototype);
SiteFusion.Classes.CodeEditor.prototype.constructor = SiteFusion.Classes.CodeEditor;
    
    SiteFusion.Classes.CodeEditor.prototype.initialize = function( win ) {
    ...
    SiteFusion.Classes.CodeEditor.prototype.handleEditorChange = function() {
        
    };

    SiteFusion.Classes.CodeEditor.prototype.makeEditable = function() {
        this.element.makeEditable("plaintext", false);
        this.fireEvent( 'madeEditable' );
    };

    SiteFusion.Classes.CodeEditor.prototype.editorLoaded = function(contents) {
    ...
    SiteFusion.Classes.CodeEditor.prototype.clearSource = function() {
    ...
    SiteFusion.Classes.CodeEditor.prototype.getSource = function() {
        var textEditor = this.textEditor;
        var source = textEditor.outputToString("text/plain", 1028);
        return source;
    };

    SiteFusion.Classes.CodeEditor.prototype.setSource = function(aText) {
        this.clearSource();

        this.insertText(aText);
    };

    SiteFusion.Classes.CodeEditor.prototype.applyStyling = function () {
    ...
    SiteFusion.Classes.CodeEditor.prototype.insertText = function(aText) {
        this.textEditor.insertText(aText);
    };

    SiteFusion.Classes.CodeEditor.prototype.yield = function() {
