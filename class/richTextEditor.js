...
SiteFusion.Classes.RichTextEditor.prototype.constructor = SiteFusion.Classes.RichTextEditor;
    ...
    SiteFusion.Classes.RichTextEditor.prototype.editorLoaded = function() {
        var oThis = this;
    ...
    SiteFusion.Classes.RichTextEditor.prototype.setValue = function( html ) {
        if (!this.textEditor) {
            return;
        }
    ...
    SiteFusion.Classes.RichTextEditor.prototype.setBodyStyle = function (prop, value) {
        var oThis = this;
        setTimeout(function() {
            if (typeof this.element.contentDocument == 'undefined' ) {
                return;
            }
            oThis.element.contentDocument.body.style[prop] = value; 
        }, 100);
    };